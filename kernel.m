...
imaneuver::yzero="Height has become less than zero at local time = `1` s";
...
~Join~
{WhenEvent[{AllTrue[{t>0.01,y[t]<0},TrueQ]},{Message[imaneuver::yzero,Round[t,0.001]];"StopIntegration"}]}
(*~Join~
...
Sow[y[t],yy[name]],
Sow[z[t],zz[name]],
Sow[\[Theta][t]/Degree,\[Theta]\[Theta][name]],
Sow[\[Psi][t]/Degree,\[Psi]\[Psi][name]],
Sow[t+t0,tt[name]],
Sow[t,localtt[name]],
...
AssociationThread[{"Name","Helicopter","Weight","Temperature","Interpolating functions"},{name,helicopter,G,temp,joined}],
...
idetails::reaperror="Reap error. It is possible that some of maneuvers parts names are the same";
